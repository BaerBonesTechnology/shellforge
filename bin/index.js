 ...
 */
const resolveScriptParams = async (scriptContent, cliArgs = {}) => {
...
await checkInit();
  ...
  var { scriptName, scriptPath, commands } = answers;
 ...
 */
const runScript = async (scriptName, cliArgs = {}) => {
  await checkForUpdates();
...
await checkInit();
  ...
  if (hasParams) {
    scriptContent = await resolveScriptParams(scriptContent, cliArgs);
